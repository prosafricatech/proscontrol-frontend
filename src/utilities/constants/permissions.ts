export const PERMISSIONS = {
  ...
  ACCOUNTS_TRANSACTIONS_CANCEL: 'AccountsTransactions:Cancel',
  ...
  BANK_RECONCILIATION_CREATE: 'BankReconciliation:Create',
  BANK_RECONCILIATION_DELETE: 'BankReconciliation:Delete',
  BANK_RECONCILIATION_EDIT: 'BankReconciliation:Edit',
  BANK_RECONCILIATION_READ: 'BankReconciliation:Read',
  COST_CENTERS_ALL: 'CostCenters:All',
  FUND_TRANSFERS_BACKDATE: 'FundTransfers:BackDate',
  FUND_TRANSFERS_CANCEL: 'FundTransfers:Cancel',
  ...
  JOURNAL_VOUCHERS_CANCEL: 'JournalVouchers:Cancel',
  ...
  SALES_MODIFY_AFTER_RECEIPT: 'Sales:ModifyAfterReceipt',
