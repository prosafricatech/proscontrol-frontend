  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm" PaperProps={{ sx: { borderRadius: '16px' } }}>
      ...
      <DialogActions sx={{ px: 3, py: 2 }}>
        ...
        <Button type="submit" form="new-ticket-form" variant="contained" sx={{ backgroundColor: '#0f172a', borderRadius: '8px', px: 2.5, textTransform: 'none', '&:hover': { backgroundColor: '#1e293b' } }}>
