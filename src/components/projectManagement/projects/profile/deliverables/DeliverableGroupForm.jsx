...
const DeliverableGroupForm = ({
  ...
  const saveMutation = deliverableGroup
  ...
  const sameLevelGroups = deliverableGroups.filter(
    (group) =>
      ...
      (parentGroup
        ? parentGroup.id
        : deliverableGroup
          ? deliverableGroup?.parent_group_id
          : null)
  );
  ...
  return (
    <>
      <DialogTitle textAlign='center'>
        {deliverableGroup
          ? `Edit: ${deliverableGroup.name}`
          : 'New Deliverable Groups'}
      </DialogTitle>
      <DialogContent>
                    ...
                    deliverableGroup
                      ? positionIndexOptions.filter(
                          (group) =>
                            ...
                            deliverableGroup?.position_index
                        )
      ...
      <DialogActions>
        ...
        <LoadingButton
          ...
          sx={{ display: 'flex' }}
          loading={
            addDeliverableGroup.isPending || updateDeliverableGroup.isPending
          }
        >
          Submit
        </LoadingButton>
